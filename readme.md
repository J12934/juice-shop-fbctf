...
Then you can import the juice-shop challenges via the the "full game" import. To get the "full game" import file you can use the [
juice-shop-ctf-cli](https://www.npmjs.com/package/juice-shop-ctf-cli) tool.
